...
public class Filters
{
    ...
    {
        get => ConfigContent.Client.CatchQualityFilter?.EnableCatchQualityFilter ?? false;
        set => ConfigContent.Client.CatchQualityFilter?.Modify(config => config.EnableCatchQualityFilter = value);
    }
    public bool EnableRarityFilter
    {
        get => ConfigContent.Client.RarityFilter?.EnableRarityFilter ?? false;
        set => ConfigContent.Client.RarityFilter?.Modify(config => config.EnableRarityFilter = value);
    }
    public bool EnableSellValueFilter
    {
        get => ConfigContent.Client.SellValueFilter?.EnableSellValueFilter ?? false;
        set => ConfigContent.Client.SellValueFilter?.Modify(config => config.EnableSellValueFilter = value);
    }
    public bool EnableItemTypeFilter
    {
        get => ConfigContent.Client.ItemTypeFilter?.EnableItemTypeFilter ?? false;
        set => ConfigContent.Client.ItemTypeFilter?.Modify(config => config.EnableItemTypeFilter = value);
    }
    public bool EnableItemIDFilter
    {
        get => ConfigContent.Client.ItemIDFilter?.EnableItemIDFilter ?? false;
        set => ConfigContent.Client.ItemIDFilter?.Modify(config => config.EnableItemIDFilter = value);
    }
}
